    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.getStartedContainer}>
          ...
          <Text style={styles.getStartedText}>Does this fish eat seals?</Text>
        ...
        <View style={styles.getStartedContainer}>
          ...
          <Text style={styles.getStartedText}>Does this fish have a long “nose”?</Text>
        ...
        <View style={styles.getStartedContainer}>
          ...
          <Text style={styles.getStartedText}>Is this fish commonly consumed by humans?</Text>
        ...
        <ScrollView
          ...
          <TouchableOpacity onPress={() => { if(response1 === true && response2 === false) {
            this.props.navigation.navigate('Shark')
          } 
          else if (response1 === false && response2 === true) {
            this.props.navigation.navigate('Swordfish')
          }
          else {
