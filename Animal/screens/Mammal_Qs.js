    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.getStartedContainer}>
          ...
          <Text style={styles.getStartedText}>Can this animal walk upright?</Text>
        ...
        <View style={styles.getStartedContainer}>
          ...
          <Text style={styles.getStartedText}>Does this animal swing from trees?</Text>
        ...
        <View style={styles.getStartedContainer}>
          ...
          <Text style={styles.getStartedText}>Does this animal eat meat?</Text>
        ...
        <ScrollView
          ...
          <TouchableOpacity onPress={() => { if(response1 === true && response2 === true && response3 === false ) {
            this.props.navigation.navigate('Gorilla')
          } 
          else if (response1 === false && response2 === false && response3 === true ) {
            this.props.navigation.navigate('Lion')
          }
